...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyotf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15360&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyotf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyotf` can be installed with:

```
conda install pyotf
```

It is possible to list all of the versions of `pyotf` available on your platform with:
